        ...
        <div className="lg:pl-72">
          ...
          <main className="py-10">
            <div className="px-4 sm:px-6 lg:px-8">
              {/* Rules-specific content */}
              <div className="p-4">
                <h1 className="text-2xl font-bold">Enterprise Rules Content</h1>
                <p className="mt-4 text-stone-600">This is where the enterprise rules content will be displayed.</p>
              </div>
            </div>
          </main>
        </div>
